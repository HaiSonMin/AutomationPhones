    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <div className='text-center mb-8'>
          ...
          <h1 className='text-3xl font-bold text-gray-900 mb-2'>Phone Manager</h1>
          <p className='text-gray-600'>Automation Tool - Desktop Application</p>
        </div>
        ...
        <div className='bg-white rounded-2xl shadow-xl p-8 border border-gray-100'>
          ...
          <div className='mt-6 pt-6 border-t border-gray-200'>
            <p className='text-center text-sm text-gray-600'>
              API Server: <span className='font-mono text-blue-600'>localhost:9000</span>
            </p>
          </div>
        </div>
        ...
        <div className='mt-6 text-center'>
          <p className='text-sm text-gray-500'>Secure authentication powered by Python Keyring</p>
        </div>
      </div>
    </div>
  );
